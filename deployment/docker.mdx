...
- An API key from [aisstream.io](https://aisstream.io) — required for live maritime vessel tracking
  ...
  <Tab title="Linux / macOS">
    <Steps>
      ...
      <Step title="Add your API keys">
        ...
        <Warning>
          `AIS_API_KEY` is required. Without it, live vessel tracking will not function. Get a free key at [aisstream.io](https://aisstream.io).
        </Warning>
      </Step>
...
|---|---|---|
| `AIS_API_KEY` | Yes | Maritime vessel tracking via [aisstream.io](https://aisstream.io) |

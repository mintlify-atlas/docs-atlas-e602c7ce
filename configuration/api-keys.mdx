...
|---|---|---|---|
| [AISStream.io](https://aisstream.io/) | Yes — `AIS_API_KEY` | Real-time vessel positions (ships layer) | Yes |
| [OpenSky Network](https://opensky-network.org/) | Yes — `OPENSKY_CLIENT_ID` + `OPENSKY_CLIENT_SECRET` | Flight gap-fill in Africa / Asia / LatAm | Yes (400 req/day) |
| [LTA DataMall](https://datamall.lta.gov.sg/) | Yes — `LTA_ACCOUNT_KEY` | Singapore CCTV traffic cameras | Yes |
...
- `GET /api/settings/api-keys`
- `PUT /api/settings/api-keys`
- `GET /api/settings/news-feeds` (write operations)
